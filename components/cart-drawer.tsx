                ...
                <li key={item.productId} className="flex items-center gap-3 px-5 py-3.5">
                  ...
                  <div className="flex shrink-0 items-center gap-1.5">
                    <button
                      ...
                      className="flex h-9 w-9 items-center justify-center rounded-md border border-hairline text-ink-soft transition-colors hover:border-ultra hover:text-ultra"
                    >
                      −
                    </button>
                  ...
                  <button
                    ...
                    className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md text-ink-soft transition-colors hover:bg-tint hover:text-red-500"
                  >
